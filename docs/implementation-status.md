...
| M11 발송 UI | 로컬 완료 | 세분화 상태·중복 tx 복구·키 회전 재포장, 사진 2,048px/WebP 전처리, 영상 capability와 10 MiB 사전 검증, 핵심 hook 회귀 테스트, static build와 Storybook |
...
- frontend: 3 files, 12 tests와 ESLint, TypeScript, Next.js static export 성공
