...
const ErrorText = styled.p`color:var(--color-status-error)!important;font-size:var(--font-size-100);&::before{margin-right:var(--space-2);content:"⚠";}`;
