...
const RetryButton = styled.button`flex:0 0 auto;min-height:42px;padding:0 var(--space-4);border:1px solid var(--color-status-error);border-radius:3px;color:var(--color-text-primary);background:transparent;cursor:pointer;&:disabled{opacity:.55;}`;
...
const Actions = styled.div`display:flex;gap:var(--space-2);button{min-height:40px;padding:0 var(--space-3);border:1px solid var(--color-border);border-radius:3px;background:transparent;color:var(--color-text-muted);cursor:pointer;&:first-of-type:not(:disabled){color:var(--color-identity-midnight-navy);background:var(--color-accent-primary);border-color:var(--color-accent-primary);}&:disabled{opacity:.45;cursor:not-allowed;}}@media(max-width:520px){button{flex:1;}}`;
