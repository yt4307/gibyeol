...
const Message = styled.p`margin-top:var(--space-8);white-space:pre-wrap;font-family:var(--font-serif);font-size:clamp(1.2rem,3vw,1.7rem);font-weight:400;line-height:1.9;`;
