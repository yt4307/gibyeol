...
export type MailboxOnboardingProps = { keyId?: number | null; active?: boolean | null; deactivationSupported?: boolean; busy?: boolean; error?: string | null; onRegister: () => void; onDeactivate: () => void };

export function MailboxOnboarding({ keyId, active, deactivationSupported = false, busy, error, onRegister, onDeactivate }: MailboxOnboardingProps) {
  ...
  return <Panel>
    ...
    {activeMailbox && deactivationSupported
