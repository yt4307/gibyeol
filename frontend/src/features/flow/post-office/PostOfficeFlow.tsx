...
export function PostOfficeFlow({ view = "send" }: PostOfficeFlowProps) {
  ...
  return <Shell>
    ...
    <Intro><Eyebrow>시간을 건너는 디지털 우체국</Eyebrow><h1>오늘의 마음을<br />별빛 아래 봉인합니다.</h1><p>지갑으로 본인을 확인하고, Passkey로 받을 준비를 한 뒤 기별을 안전하게 봉인해 보세요.</p></Intro>
    <Workspace>
...
const Intro = styled.section`position:relative;z-index:1;width:min(100%,1100px);margin:clamp(64px,11vh,120px) auto var(--space-12);h1{max-width:760px;margin-top:var(--space-4);font-family:var(--font-family-display);font-size:clamp(2.7rem,6.5vw,5.5rem);font-weight:400;line-height:1.12;letter-spacing:-.055em;}p{max-width:560px;margin-top:var(--space-6);color:var(--color-text-muted);font-size:var(--font-size-300);line-height:1.7;word-break:keep-all;}`;
